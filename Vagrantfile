...
# provision the four nodes for this Kubernetes cluster
  config.vm.provision "shell", inline: "echo swapoff -a"
  ...
  config.vm.define "c1-node2" do |c1node2|
    c1node2.vm.box = "bento/ubuntu-18.04"
  ...
  config.vm.define "c1-node3" do |c1node3|
    c1node3.vm.box = "bento/ubuntu-18.04"
